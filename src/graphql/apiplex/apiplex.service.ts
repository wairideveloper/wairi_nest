...
※문의사항은 카카오톡 wairi 채널 혹은 홈페이지 채널톡을 이용해주시길 바랍니다. 감사합니다.`
    ...
    private _12jSKar7G587(data: any) {
        return "[캠페인 신청 알림] \n" +
            "\n" +
    ...
    private _1ZBQ0QxY7WI9(data: any) {
        return "[캠페인 신청 대기 알림]\n" +
            "\n" +
    ...
    private _1EHu0hjNSYvP(data: any) {
    ...
    private _18memDED3j3V(data: any) {
        return "[캠페인 결제 알림]\n" +
            "\n" +
            "안녕하세요 #{이름}님 여행 인플루언서 플랫폼 와이리입니다.\n" +
            "아래 내용으로 예약이 확정되었습니다.\n" +
